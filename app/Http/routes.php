...
Route::group(['middleware' => ['web']], function () {
    ...
    Route::get('searchebay', 'SearchController@searchEbay');
    Route::get('searchaliexpress', 'SearchController@searchAliexpress');
    Route::get('searchaliexpresslist', 'SearchController@searchAliexpressList');
